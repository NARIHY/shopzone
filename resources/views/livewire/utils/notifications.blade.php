<div class="fixed bottom-5 right-5 space-y-3 z-50 pointer-events-none">
    @foreach ($notifications as $notification)
        ...
        >
            ...
            <div class="{{ $bg }} text-white px-4 py-3 rounded-lg shadow-xl flex items-center justify-between transform-gpu">
                ...
                <button @click="show = false" class="ml-3 text-white hover:text-gray-200 transition">

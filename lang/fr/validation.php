...
return [
    ...
    | versions, comme les règles de taille. Vous pouvez personnaliser
    | chaque message ici selon vos besoins.
    |
    */
    ...
    | vos attributs en utilisant la convention "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes servent à remplacer les noms d'attributs par
    | quelque chose de plus lisible, comme "Adresse e-mail" au lieu de "email".
    |
    */
